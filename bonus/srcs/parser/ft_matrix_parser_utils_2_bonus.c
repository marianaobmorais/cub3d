...
/*   Updated: 2025/04/10 20:37:30 by joneves-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Checks if a sprite character is valid within a map line.
 *
 * A sprite is considered valid if:
 * - The character above it (same x in previous line) is not a space.
 * - It is surrounded horizontally by non-space characters, and the next
 ...
 * @param x The horizontal position (index) being validated.
 * @return true If the sprite at position x is valid.
