...
/*   Updated: 2025/03/31 23:13:57 by joneves-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_render_breads(t_cub *cub)
{
	if (cub->amount_action < BREAD_3 + 1)
		ft_render_source_on_hud(cub, &cub->hud->viewmodel, (WIDTH - 256) / 2, HEIGHT - 256);
