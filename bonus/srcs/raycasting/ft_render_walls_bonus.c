...
/*   Updated: 2025/04/04 19:26:47 by joneves-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_render_walls(t_cub *cub)
{
	...
	while (w < WIDTH)
	{
		...
		{
			double dist = cub->raycast->door_dist;
			int side =  cub->raycast->door_side;
			...
			ft_paint_ray_door(cub, w, cub->hud->door, dist, side, wall_hit);
		}
