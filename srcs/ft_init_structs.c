...
void	ft_init_texture(t_cub *cub)
{
	...
	ray->north_texture.addr = mlx_get_data_addr(ray->north_texture.img_ptr, &ray->north_texture.bpp, &ray->north_texture.line_len, &ray->north_texture.endian);
	...
	ray->south_texture.addr = mlx_get_data_addr(ray->south_texture.img_ptr, &ray->south_texture.bpp, &ray->south_texture.line_len, &ray->south_texture.endian);
	...
	ray->east_texture.addr = mlx_get_data_addr(ray->east_texture.img_ptr, &ray->east_texture.bpp, &ray->east_texture.line_len, &ray->east_texture.endian);
	...
	ray->west_texture.addr = mlx_get_data_addr(ray->west_texture.img_ptr, &ray->west_texture.bpp, &ray->west_texture.line_len, &ray->west_texture.endian);

	if (!ray->north_texture.img_ptr || !ray->south_texture.img_ptr
		|| !ray->east_texture.img_ptr || !ray->west_texture.img_ptr)
		ft_handle_error("mlx_xpm_file_to_image", cub); //test this later //check addr too?
}
